...
public class FrequenciaTest 
{
	...
	@Test
	public void t01_criarFrequencias() throws Exception 
	{
	...
	@Test
	public void t02_consultarFrequencias() throws Exception 
	{
	...
	public void t03_aprovarFrequencia() throws Exception {
		...
		Frequencia frequencia = frequenciabean.findByMonitoria(monitoria).frequencias.get(0);
		frequenciabean.aprovarFrequencia(frequencia, true);
		
		frequencia = frequenciabean.findByMonitoria(monitoria).frequencias.get(0);
		assertFalse(frequencia.isAprovado());
	}
	...
	public void t04_receberFrequencia() throws Exception {
		...
		Frequencia frequencia = frequenciabean.findByMonitoria(monitoria).frequencias.get(0);
		frequenciabean.receberFrequencia(frequencia);
		
		frequencia = frequenciabean.findByMonitoria(monitoria).frequencias.get(0);
		assertFalse(frequencia.isRecebido());
	}
